...
void Timezones::current() {
	...
	cout << endl << "Please input the city whose time zone you wish to know (Capitalize city and NO SPACES): ";//Meaning the city entered has to start with a capital letter
...
void Timezones::regular() {
	if (found)
	{
		hours2 = hourss + t2 + 8.0;//Hours of city is offset from Spokane to 00:00 plus offset from 00:00 to requested city
		cout << hours2 << endl;
		if (hours2 >= 24)//If city is one-day ahead
		{
